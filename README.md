...
|---|
| Figma, Adobe Illustrator, Zenhub, Microsoft Teams |
...
| HTML+CSS, Local by Flywheel, WordPress PHP |
|---|
| Basecamp  |
...
| HTML+CSS, JavaScript, React.js, Heroku, Firebase  |
|---|
...
| HTML+CSS, JavaScript, Bootstrap, Node, Express, MySQL, Sequelize, Heroku  |
|---|
| Adobe XD, Adobe Illustrator  |
...
| HTML+CSS, JavaScript, Express.js, Node.js, Heroku  |
|---|
| Procreate |
